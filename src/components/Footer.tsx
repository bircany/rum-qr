      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8 flex justify-center">
          <a 
            ...
            className="flex items-center gap-3 bg-white/50 backdrop-blur-sm border border-navy/10 px-6 py-3 rounded-xl shadow-sm hover:shadow-md hover:bg-white transition-all duration-300 group"
          >
            ...
            <span className="text-navy font-sans font-medium">İleri Tarihli Rezervasyon</span>
          </a>
        </div>
